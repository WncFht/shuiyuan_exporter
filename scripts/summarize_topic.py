...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description='Summarize a cached Shuiyuan topic for the skill runtime.')
    ...
    parser.add_argument('--focus-keyword', action='append', dest='focus_keywords', help='Keyword to count in the summary')
    parser.add_argument('--include-images', action='store_true', help='Include image paths in the underlying query context')
