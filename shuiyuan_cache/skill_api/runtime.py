...
def build_skill_config(
    ...
    resolved_cache_root = _expand(cache_root) if cache_root else default_skill_cache_root()
    resolved_cookie_path = _expand(cookie_path) if cookie_path else default_skill_cookie_path()
