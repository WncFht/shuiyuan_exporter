...
class TopicInspectService:
    ...
    def inspect_topic(self, topic: str | int) -> TopicInspectResult:
        ...
        json_page_count = self._count_files(
            self.paths.json_pages_dir(topic_id), "*.json"
        )
        ...
        if (
            ...
            and topic_row["posts_count"]
            and db_post_count < topic_row["posts_count"]
        ):
        ...
        return TopicInspectResult(
            ...
            last_sync_finished_at=sync_row["last_sync_finished_at"]
            if sync_row
            else None,
