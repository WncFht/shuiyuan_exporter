...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description='Query cached Shuiyuan posts for the skill runtime.')
    ...
    parser.add_argument('--only-op', action='store_true', help='Only include posts by the original poster')
    parser.add_argument('--date-from', help='Lower bound date/time (ISO date or datetime)')
    parser.add_argument('--date-to', help='Upper bound date/time (ISO date or datetime)')
    parser.add_argument('--has-images', action='store_true', help='Only include posts with images')
    parser.add_argument('--no-images-filter', action='store_true', help='Only include posts without images')
    parser.add_argument('--limit', type=int, default=50, help='Maximum number of posts to return')
